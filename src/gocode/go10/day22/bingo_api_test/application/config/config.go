...
func Init(filePath string) error {
	...
	//读取SSH全局密钥对
	publicKeyByte, _ := ioutil.ReadFile(Conf.SSHGlobalKeys.PublicKeyPath)
	privateKeyByte, _ := ioutil.ReadFile(Conf.SSHGlobalKeys.PrivateKeyPath)
	Conf.SSHGlobalKeys.PublicKey = string(publicKeyByte)
	Conf.SSHGlobalKeys.PrivateKey = string(privateKeyByte)
